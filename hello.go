...
//PrintData is init Mydata method.
...
//PrintData is init Yourdata method.
func (md *Yourdata) PrintData() {
	fmt.Printf("I'm %s. (%d).¥n", md.Name, md.Age)
	fmt.Printf("mail: %s.¥n", md.Mail)
}
